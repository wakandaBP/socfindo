			...
			<div class="card">
				...
				<div class="body">
					...
					<div style="text-align: right;">
						<a href="<?php echo $tckaret;?>/plantation_field.add" class="btn btn-primary">+ Add</a>
					</div>
					<div class="body" style="overflow-x: scroll;"> 
						<table class="table table-bordered table-striped dataTable" id="list-plantation-field" style="text-align:center;">
							<thead>
								<tr>
									...
									<th class="text-center">Quantity Stands after 1st Cencus</th>
