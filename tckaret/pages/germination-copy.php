			...
			<div class="card">
				<div class="header bg-cyan">
					<h1 style="font-size: 12pt; padding-bottom: 5px">
						Observasi Germination List
					</h1>
					<ul class="header-dropdown m-r--5" style="padding-top: 5px">
						<li>
							<a href="germination-add" class="btnTambah">
								<button class="btn btn-info btn-sm">Germnation List II Add</button>
							</a>
						</li>
					</ul>
				</div>
				<div class="body">
					<div class="modal-body" id="form-data">
						<div class="row">
							<h3>Observasi Germination List</h3>
						</div>	
						<div class="row clearfix">
							<div class="col-md-3">
					...
					<table class="table table-bordered table-striped dataTable" id="example3">
						<thead>
							<tr>
								...
								<th class="text-center">ScreeningDate</th>
