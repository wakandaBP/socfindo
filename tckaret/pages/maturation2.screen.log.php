...
?>
<form>
	<div class="modal fade" tabindex="-1" role="dialog" id="form-addmat2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header"><h5> <span id="count"></span> Maturation II Screening for ID Embryo : <?= $page[1]; ?></h5> </div> 
                <form id="addmat2">
		...
		<div class="card">
			<div class="header bg-cyan">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<h5>
							Maturation II Screening Log for ID Embryo : <?= $page[1];?>
						</h5>
			...
			<div class="body">
				<table class="table table-bordered table-striped dataTable" id="list-mat2log" style="text-align: center;">
					<thead>
						<tr>
				...
				<div style="text-align: right;">
					<a href="<?php echo $tckaret;?>/maturation2" class="btn btn-primary btn-sm">Back</a>
				</div>
			</div>
		</div>
	</div>
