	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header bg-cyan">
				<h5 style="" >
					Add Hardening from Acclimatization
				</h5>
			</div>
			<div class="body" id="form-data" style="padding: 2% 5% 2% 5%";>
				<fieldset>
					<div class="row clearfix">
						<div class="col-sm-12">
							<h6>Parent Acclimatization *</h6>
							<div class="input-group">
								<div class="form-line">
									<select id="parent_acc" class="form-control useselect2 parent_form parent_acc" required>
						...
						<table class="table table-bordered table-striped dataTable" id="list-parent" style="text-align:center;">
							<thead>
								<tr>
									...
									<th class="text-center">Acclimatization Ending</th>
