			...
			<div class="body" id="form-data" style="padding: 2% 5% 2% 5%";>
				<fieldset>
					<div class="row clearfix">
						<div class="col-sm-10">
							<h6>Parent Stock For Cutting *</h6>
							<div class="input-group">
								<div class="form-line">
									<select id="parent_cutting" class="form-control useselect2 parent_form parent_cutting" required>
						...
						<table class="table table-bordered table-striped dataTable" id="list-parent" style="text-align:center;">
							<thead>
								<tr>
									...
									<th class="text-center">Stock For Cutting Ending</th>
...
<form id="add-rooting">
				<fieldset>
					...
					<div class="text-center" style="padding-bottom: 30px">
						...
						<a href="<?php echo $tckaret;?>/rooting" class="btn btn-danger btn-sm">Cancel</a>
					</div>
				</div>
			</fieldset>
		</div>
