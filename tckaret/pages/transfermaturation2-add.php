			...
			<div class="card">
				<div class="header bg-cyan">
					...
					<ul class="header-dropdown m-r--5" style="padding-top: 5px">
						<li>
							<a href="maturation2" class="btnTambah">
								<button class="btn btn-info btn-sm">Observation Maturation II</button>
							</a>
						</li>
					</ul>
				</div>
				<div class="body">
					<div class="modal-body" id="form-data">
						<div class="row clearfix">
							<div class="col-md-3">
								<h5 style="padding-left: 30px">id_Treatment:</h5>
									<div class="form-line">
										<input type="text" class="form-control" name="nama" required="required">
									</div>
							</div>
							<div class="col-md-3">
								<h5 style="padding-left: 30px">Screening Date:</h5>
									<div class="form-line">
							...
							<div class="form-line">
								<a href="#" class="btn btn-info btn-sm">FIND</a>
							</div>
					</div>
					...
					<!-- <table class="table table-bordered table-striped dataTable" id="example3">
						<thead>
							<tr>
								<th width="30px" class="text-center">ID_Treatment</th>
								<th class="text-center">ID_Reception</th>
								<th class="text-center">Screening Date</th>
								<th class="text-center">Iteration</th>
								<th class="text-center">Worker</th>
								<th class="text-center">Se</th>
								<th class="text-center">Ze</th>
								<th class="text-center">Transfer Same Media</th>
