...
?>
<form>
	<div class="modal fade" tabindex="-1" role="dialog" id="form-add-germ-screen">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header"><h5> <span id="count"></span> Germination Screening for ID Embryo : <?= $page[1]; ?></h5> </div> 
                <form id="addmat2">
		...
		<div class="card">
			<div class="header bg-cyan">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<h5>
							Germination Screening Log for ID Embryo : <?= $page[1];?>
						</h5>
			...
			<div class="body">
				<table class="table table-bordered table-striped dataTable" id="list-germlog" style="text-align: center;">
					<thead>
						<tr>
