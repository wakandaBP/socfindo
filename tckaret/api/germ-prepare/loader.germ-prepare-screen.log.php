<?php 
	...
	$MetaData = array();
	$query = new Database("SELECT * FROM karet_embryo_germination_prepare_screening WHERE id_embryo = ? 
							AND isactive = ? ORDER BY screening_checkpoint DESC",array($_POST['id'],1));
