<script type="text/javascript">
	$(function(){
		...
		var regionList = $("#list-region").DataTable({

			"ajax":{
				"url": hostname + "/api/loader.region.php",
				"data":{
					id:id
				},
				"type":"POST"
			...
			"columns" : [
				...
				{
					"data" : null, render: function(data, type, row, meta) {
						return	"<div style='text-align:center;'><a href=\"" + hostname + "/region.edit/" + row["id"] + "\" class=\"btn btn-info btn-circle waves-effect waves-circle waves-float\"><i class=\"material-icons\">edit</i></a>" +
		...
		$("body").on("click", ".btn-delete", function(){
			...
			var conf = confirm("Delete Region : " + nama + " ?");
			if(conf){
				$.ajax({
